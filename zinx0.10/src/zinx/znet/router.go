...
//定义一个处理链接业务的方法
type HandleFunc func(request ziface.IRequest)

func (h HandleFunc) PreHandle(request ziface.IRequest) {}

func (h HandleFunc) Handle(request ziface.IRequest) { h(request) }

func (h HandleFunc) PostHandle(request ziface.IRequest) {}
